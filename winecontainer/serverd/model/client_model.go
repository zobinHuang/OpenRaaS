...
*/
const (
	CLIENT_TYPE_STREAMER string = "streamer"
)
...
*/
const (
	ERROR_TYPE_STORAGE  string = "storage"
	ERROR_TYPE_INSTANCE string = "instance"
	ERROR_TYPE_REMOVE   string = "remove"
)

/*
	@model: Streamer
	@description: provider streamer client
*/
